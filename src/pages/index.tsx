...
import RenderScene from '@/renders/RenderScene'
  ...
  return (
    <div className='flex flex-row gap-1'>
        ...
        <div className='flex flex-col relative mx-auto mt-4 sm:w-2/4 w-3/4 md:h-[8rem] sm:h-[4rem] h-[8rem] rounded-lg pb-1 shadow-2xl'>
          ...
          <button className='absolute md:w-[15%] sm:w-[10%] w-[15%] md:h-auto sm:h-6 h-auto bottom-0 md:text-base text-xs right-0 z-[1] bg-gray-200 hover:bg-gray-300 transition-all border-2 border-gray-800 rounded-lg md:p-1 m-1' onClick={e => {
            e.preventDefault();
